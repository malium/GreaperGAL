...
union EGL
{
	...
	static constexpr EGLenum GL_COLORSPACE_BT2020_HLG_EXT = 0x3540;
	...
	static constexpr EGLenum NATIVE_BUFFER_QNX = 0x3551;
	static constexpr EGLenum PLATFORM_SCREEN_QNX = 0x3550;
	...
	static constexpr const char* ProcNameList[157] = {
		"eglChooseConfig",
		"eglCopyBuffers",
		"eglCreateContext",
