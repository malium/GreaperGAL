...
union GLX
{
	...
	static constexpr GLenum WINDOW_BIT = 0x00000001;
	static constexpr GLenum PIXMAP_BIT = 0x00000002;
	static constexpr GLenum PBUFFER_BIT = 0x00000004;
	static constexpr GLenum RGBA_BIT = 0x00000001;
	static constexpr GLenum COLOR_INDEX_BIT = 0x00000002;
	static constexpr GLenum PBUFFER_CLOBBER_MASK = 0x08000000;
	static constexpr GLenum FRONT_LEFT_BUFFER_BIT = 0x00000001;
	static constexpr GLenum FRONT_RIGHT_BUFFER_BIT = 0x00000002;
	static constexpr GLenum BACK_LEFT_BUFFER_BIT = 0x00000004;
	static constexpr GLenum BACK_RIGHT_BUFFER_BIT = 0x00000008;
	static constexpr GLenum AUX_BUFFERS_BIT = 0x00000010;
	static constexpr GLenum DEPTH_BUFFER_BIT = 0x00000020;
	static constexpr GLenum STENCIL_BUFFER_BIT = 0x00000040;
	static constexpr GLenum ACCUM_BUFFER_BIT = 0x00000080;
	static constexpr GLenum CONFIG_CAVEAT = 0x20;
	static constexpr GLenum X_VISUAL_TYPE = 0x22;
	static constexpr GLenum TRANSPARENT_TYPE = 0x23;
	static constexpr GLenum TRANSPARENT_INDEX_VALUE = 0x24;
	static constexpr GLenum TRANSPARENT_RED_VALUE = 0x25;
	static constexpr GLenum TRANSPARENT_GREEN_VALUE = 0x26;
	static constexpr GLenum TRANSPARENT_BLUE_VALUE = 0x27;
	static constexpr GLenum TRANSPARENT_ALPHA_VALUE = 0x28;
	static constexpr GLenum DONT_CARE = 0xFFFFFFFF;
	static constexpr GLenum NONE = 0x8000;
	static constexpr GLenum SLOW_CONFIG = 0x8001;
	static constexpr GLenum TRUE_COLOR = 0x8002;
	static constexpr GLenum DIRECT_COLOR = 0x8003;
	static constexpr GLenum PSEUDO_COLOR = 0x8004;
	static constexpr GLenum STATIC_COLOR = 0x8005;
	static constexpr GLenum GRAY_SCALE = 0x8006;
	static constexpr GLenum STATIC_GRAY = 0x8007;
	static constexpr GLenum TRANSPARENT_RGB = 0x8008;
	static constexpr GLenum TRANSPARENT_INDEX = 0x8009;
	static constexpr GLenum VISUAL_ID = 0x800B;
	static constexpr GLenum SCREEN = 0x800C;
	static constexpr GLenum NON_CONFORMANT_CONFIG = 0x800D;
	static constexpr GLenum DRAWABLE_TYPE = 0x8010;
	static constexpr GLenum RENDER_TYPE = 0x8011;
	static constexpr GLenum X_RENDERABLE = 0x8012;
	static constexpr GLenum FBCONFIG_ID = 0x8013;
	static constexpr GLenum RGBA_TYPE = 0x8014;
	static constexpr GLenum COLOR_INDEX_TYPE = 0x8015;
	static constexpr GLenum MAX_PBUFFER_WIDTH = 0x8016;
	static constexpr GLenum MAX_PBUFFER_HEIGHT = 0x8017;
	static constexpr GLenum MAX_PBUFFER_PIXELS = 0x8018;
	static constexpr GLenum PRESERVED_CONTENTS = 0x801B;
	static constexpr GLenum LARGEST_PBUFFER = 0x801C;
	static constexpr GLenum WIDTH = 0x801D;
	static constexpr GLenum HEIGHT = 0x801E;
	static constexpr GLenum EVENT_MASK = 0x801F;
	static constexpr GLenum DAMAGED = 0x8020;
	static constexpr GLenum SAVED = 0x8021;
	static constexpr GLenum WINDOW = 0x8022;
	static constexpr GLenum PBUFFER = 0x8023;
	static constexpr GLenum PBUFFER_HEIGHT = 0x8040;
	static constexpr GLenum PBUFFER_WIDTH = 0x8041;
	static constexpr GLenum SAMPLE_BUFFERS = 100000;
	static constexpr GLenum SAMPLES = 100001;
	...
	static constexpr GLenum RGBA_FLOAT_TYPE_ARB = 0x20B9;
	static constexpr GLenum RGBA_FLOAT_BIT_ARB = 0x00000004;
	static constexpr GLenum FRAMEBUFFER_SRGB_CAPABLE_ARB = 0x20B2;
	static constexpr GLenum SAMPLE_BUFFERS_ARB = 100000;
	static constexpr GLenum SAMPLES_ARB = 100001;
	static constexpr GLenum CONTEXT_RESET_ISOLATION_BIT_ARB = 0x00000008;
	static constexpr GLenum CONTEXT_ALLOW_BUFFER_BYTE_ORDER_MISMATCH_ARB = 0x2095;
	static constexpr GLenum SAMPLE_BUFFERS_3DFX = 0x8050;
	static constexpr GLenum SAMPLES_3DFX = 0x8051;
	...
	static constexpr GLenum BACK_BUFFER_AGE_EXT = 0x20F4;
	static constexpr GLenum CONTEXT_PRIORITY_LEVEL_EXT = 0x3100;
	static constexpr GLenum CONTEXT_PRIORITY_HIGH_EXT = 0x3101;
	static constexpr GLenum CONTEXT_PRIORITY_MEDIUM_EXT = 0x3102;
	static constexpr GLenum CONTEXT_PRIORITY_LOW_EXT = 0x3103;
	...
	static constexpr GLenum RGBA_UNSIGNED_FLOAT_TYPE_EXT = 0x20B1;
	static constexpr GLenum RGBA_UNSIGNED_FLOAT_BIT_EXT = 0x00000008;
	static constexpr GLenum FRAMEBUFFER_SRGB_CAPABLE_EXT = 0x20B2;
	static constexpr GLenum SHARE_CONTEXT_EXT = 0x800A;
	static constexpr GLenum VISUAL_ID_EXT = 0x800B;
	static constexpr GLenum SCREEN_EXT = 0x800C;
	static constexpr GLenum VENDOR_NAMES_EXT = 0x20F6;
	static constexpr GLenum STEREO_TREE_EXT = 0x20F5;
	static constexpr GLenum STEREO_NOTIFY_MASK_EXT = 0x00000001;
	static constexpr GLenum STEREO_NOTIFY_EXT = 0x00000000;
	static constexpr GLenum SWAP_INTERVAL_EXT = 0x20F1;
	static constexpr GLenum MAX_SWAP_INTERVAL_EXT = 0x20F2;
	static constexpr GLenum LATE_SWAPS_TEAR_EXT = 0x20F3;
	static constexpr GLenum TEXTURE_1D_BIT_EXT = 0x00000001;
	static constexpr GLenum TEXTURE_2D_BIT_EXT = 0x00000002;
	static constexpr GLenum TEXTURE_RECTANGLE_BIT_EXT = 0x00000004;
	static constexpr GLenum BIND_TO_TEXTURE_RGB_EXT = 0x20D0;
	static constexpr GLenum BIND_TO_TEXTURE_RGBA_EXT = 0x20D1;
	static constexpr GLenum BIND_TO_MIPMAP_TEXTURE_EXT = 0x20D2;
	static constexpr GLenum BIND_TO_TEXTURE_TARGETS_EXT = 0x20D3;
	static constexpr GLenum Y_INVERTED_EXT = 0x20D4;
	static constexpr GLenum TEXTURE_FORMAT_EXT = 0x20D5;
	static constexpr GLenum TEXTURE_TARGET_EXT = 0x20D6;
	static constexpr GLenum MIPMAP_TEXTURE_EXT = 0x20D7;
	static constexpr GLenum TEXTURE_FORMAT_NONE_EXT = 0x20D8;
	static constexpr GLenum TEXTURE_FORMAT_RGB_EXT = 0x20D9;
	static constexpr GLenum TEXTURE_FORMAT_RGBA_EXT = 0x20DA;
	static constexpr GLenum TEXTURE_1D_EXT = 0x20DB;
	static constexpr GLenum TEXTURE_2D_EXT = 0x20DC;
	static constexpr GLenum TEXTURE_RECTANGLE_EXT = 0x20DD;
	static constexpr GLenum FRONT_LEFT_EXT = 0x20DE;
	static constexpr GLenum FRONT_RIGHT_EXT = 0x20DF;
	static constexpr GLenum BACK_LEFT_EXT = 0x20E0;
	static constexpr GLenum BACK_RIGHT_EXT = 0x20E1;
	static constexpr GLenum FRONT_EXT = 0x20DE;
	static constexpr GLenum BACK_EXT = 0x20E0;
	static constexpr GLenum AUX0_EXT = 0x20E2;
	static constexpr GLenum AUX1_EXT = 0x20E3;
	static constexpr GLenum AUX2_EXT = 0x20E4;
	static constexpr GLenum AUX3_EXT = 0x20E5;
	static constexpr GLenum AUX4_EXT = 0x20E6;
	static constexpr GLenum AUX5_EXT = 0x20E7;
	static constexpr GLenum AUX6_EXT = 0x20E8;
	static constexpr GLenum AUX7_EXT = 0x20E9;
	static constexpr GLenum AUX8_EXT = 0x20EA;
	static constexpr GLenum AUX9_EXT = 0x20EB;
	static constexpr GLenum X_VISUAL_TYPE_EXT = 0x22;
	static constexpr GLenum TRANSPARENT_TYPE_EXT = 0x23;
	static constexpr GLenum TRANSPARENT_INDEX_VALUE_EXT = 0x24;
	static constexpr GLenum TRANSPARENT_RED_VALUE_EXT = 0x25;
	static constexpr GLenum TRANSPARENT_GREEN_VALUE_EXT = 0x26;
	static constexpr GLenum TRANSPARENT_BLUE_VALUE_EXT = 0x27;
	static constexpr GLenum TRANSPARENT_ALPHA_VALUE_EXT = 0x28;
	static constexpr GLenum NONE_EXT = 0x8000;
	static constexpr GLenum TRUE_COLOR_EXT = 0x8002;
	static constexpr GLenum DIRECT_COLOR_EXT = 0x8003;
	static constexpr GLenum PSEUDO_COLOR_EXT = 0x8004;
	static constexpr GLenum STATIC_COLOR_EXT = 0x8005;
	static constexpr GLenum GRAY_SCALE_EXT = 0x8006;
	static constexpr GLenum STATIC_GRAY_EXT = 0x8007;
	static constexpr GLenum TRANSPARENT_RGB_EXT = 0x8008;
	static constexpr GLenum TRANSPARENT_INDEX_EXT = 0x8009;
	static constexpr GLenum VISUAL_CAVEAT_EXT = 0x20;
	static constexpr GLenum SLOW_VISUAL_EXT = 0x8001;
	static constexpr GLenum NON_CONFORMANT_VISUAL_EXT = 0x800D;
	static constexpr GLenum BUFFER_SWAP_COMPLETE_INTEL_MASK = 0x04000000;
	static constexpr GLenum EXCHANGE_COMPLETE_INTEL = 0x8180;
	static constexpr GLenum COPY_COMPLETE_INTEL = 0x8181;
	static constexpr GLenum FLIP_COMPLETE_INTEL = 0x8182;
	static constexpr GLenum RENDERER_VENDOR_ID_MESA = 0x8183;
	static constexpr GLenum RENDERER_DEVICE_ID_MESA = 0x8184;
	static constexpr GLenum RENDERER_VERSION_MESA = 0x8185;
	static constexpr GLenum RENDERER_ACCELERATED_MESA = 0x8186;
	static constexpr GLenum RENDERER_VIDEO_MEMORY_MESA = 0x8187;
	static constexpr GLenum RENDERER_UNIFIED_MEMORY_ARCHITECTURE_MESA = 0x8188;
	static constexpr GLenum RENDERER_PREFERRED_PROFILE_MESA = 0x8189;
	static constexpr GLenum RENDERER_OPENGL_CORE_PROFILE_VERSION_MESA = 0x818A;
	static constexpr GLenum RENDERER_OPENGL_COMPATIBILITY_PROFILE_VERSION_MESA = 0x818B;
	static constexpr GLenum RENDERER_OPENGL_ES_PROFILE_VERSION_MESA = 0x818C;
	static constexpr GLenum RENDERER_OPENGL_ES2_PROFILE_VERSION_MESA = 0x818D;
	static constexpr GLenum GLX_3DFX_WINDOW_MODE_MESA = 0x1;
	static constexpr GLenum GLX_3DFX_FULLSCREEN_MODE_MESA = 0x2;
	...
	static constexpr GLenum COVERAGE_SAMPLES_NV = 100001;
	static constexpr GLenum COLOR_SAMPLES_NV = 0x20B3;
	static constexpr GLenum NUM_VIDEO_SLOTS_NV = 0x20F0;
	static constexpr GLenum GENERATE_RESET_ON_VIDEO_MEMORY_PURGE_NV = 0x20F7;
	static constexpr GLenum DEVICE_ID_NV = 0x20CD;
	...
	static constexpr GLenum VIDEO_OUT_FRAME_NV = 0x20C8;
	static constexpr GLenum VIDEO_OUT_FIELD_1_NV = 0x20C9;
	static constexpr GLenum VIDEO_OUT_FIELD_2_NV = 0x20CA;
	static constexpr GLenum VIDEO_OUT_STACKED_FIELDS_1_2_NV = 0x20CB;
	static constexpr GLenum VIDEO_OUT_STACKED_FIELDS_2_1_NV = 0x20CC;
	static constexpr GLenum SWAP_METHOD_OML = 0x8060;
	static constexpr GLenum SWAP_EXCHANGE_OML = 0x8061;
	static constexpr GLenum SWAP_COPY_OML = 0x8062;
	static constexpr GLenum SWAP_UNDEFINED_OML = 0x8063;
	static constexpr GLenum BLENDED_RGBA_SGIS = 0x8025;
	static constexpr GLenum SAMPLE_BUFFERS_SGIS = 100000;
	static constexpr GLenum SAMPLES_SGIS = 100001;
	static constexpr GLenum MULTISAMPLE_SUB_RECT_WIDTH_SGIS = 0x8026;
	static constexpr GLenum MULTISAMPLE_SUB_RECT_HEIGHT_SGIS = 0x8027;
	static constexpr GLenum DIGITAL_MEDIA_PBUFFER_SGIX = 0x8024;
	static constexpr GLenum WINDOW_BIT_SGIX = 0x00000001;
	static constexpr GLenum PIXMAP_BIT_SGIX = 0x00000002;
	static constexpr GLenum RGBA_BIT_SGIX = 0x00000001;
	static constexpr GLenum COLOR_INDEX_BIT_SGIX = 0x00000002;
	static constexpr GLenum DRAWABLE_TYPE_SGIX = 0x8010;
	static constexpr GLenum RENDER_TYPE_SGIX = 0x8011;
	static constexpr GLenum X_RENDERABLE_SGIX = 0x8012;
	static constexpr GLenum FBCONFIG_ID_SGIX = 0x8013;
	static constexpr GLenum RGBA_TYPE_SGIX = 0x8014;
	static constexpr GLenum COLOR_INDEX_TYPE_SGIX = 0x8015;
	static constexpr GLenum HYPERPIPE_PIPE_NAME_LENGTH_SGIX = 80;
	static constexpr GLenum BAD_HYPERPIPE_CONFIG_SGIX = 91;
	static constexpr GLenum BAD_HYPERPIPE_SGIX = 92;
	static constexpr GLenum HYPERPIPE_DISPLAY_PIPE_SGIX = 0x00000001;
	static constexpr GLenum HYPERPIPE_RENDER_PIPE_SGIX = 0x00000002;
	static constexpr GLenum PIPE_RECT_SGIX = 0x00000001;
	static constexpr GLenum PIPE_RECT_LIMITS_SGIX = 0x00000002;
	static constexpr GLenum HYPERPIPE_STEREO_SGIX = 0x00000003;
	static constexpr GLenum HYPERPIPE_PIXEL_AVERAGE_SGIX = 0x00000004;
	static constexpr GLenum HYPERPIPE_ID_SGIX = 0x8030;
	static constexpr GLenum PBUFFER_BIT_SGIX = 0x00000004;
	static constexpr GLenum BUFFER_CLOBBER_MASK_SGIX = 0x08000000;
	static constexpr GLenum FRONT_LEFT_BUFFER_BIT_SGIX = 0x00000001;
	static constexpr GLenum FRONT_RIGHT_BUFFER_BIT_SGIX = 0x00000002;
	static constexpr GLenum BACK_LEFT_BUFFER_BIT_SGIX = 0x00000004;
	static constexpr GLenum BACK_RIGHT_BUFFER_BIT_SGIX = 0x00000008;
	static constexpr GLenum AUX_BUFFERS_BIT_SGIX = 0x00000010;
	static constexpr GLenum DEPTH_BUFFER_BIT_SGIX = 0x00000020;
	static constexpr GLenum STENCIL_BUFFER_BIT_SGIX = 0x00000040;
	static constexpr GLenum ACCUM_BUFFER_BIT_SGIX = 0x00000080;
	static constexpr GLenum SAMPLE_BUFFERS_BIT_SGIX = 0x00000100;
	static constexpr GLenum MAX_PBUFFER_WIDTH_SGIX = 0x8016;
	static constexpr GLenum MAX_PBUFFER_HEIGHT_SGIX = 0x8017;
	static constexpr GLenum MAX_PBUFFER_PIXELS_SGIX = 0x8018;
	static constexpr GLenum OPTIMAL_PBUFFER_WIDTH_SGIX = 0x8019;
	static constexpr GLenum OPTIMAL_PBUFFER_HEIGHT_SGIX = 0x801A;
	static constexpr GLenum PRESERVED_CONTENTS_SGIX = 0x801B;
	static constexpr GLenum LARGEST_PBUFFER_SGIX = 0x801C;
	static constexpr GLenum WIDTH_SGIX = 0x801D;
	static constexpr GLenum HEIGHT_SGIX = 0x801E;
	static constexpr GLenum EVENT_MASK_SGIX = 0x801F;
	static constexpr GLenum DAMAGED_SGIX = 0x8020;
	static constexpr GLenum SAVED_SGIX = 0x8021;
	static constexpr GLenum WINDOW_SGIX = 0x8022;
	static constexpr GLenum PBUFFER_SGIX = 0x8023;
	static constexpr GLenum SYNC_FRAME_SGIX = 0x00000000;
	static constexpr GLenum SYNC_SWAP_SGIX = 0x00000001;
	static constexpr GLenum VISUAL_SELECT_GROUP_SGIX = 0x8028;
